   ...
   <body id="inner_page">
                                   ...
                                   <div class="form_cont">
                                       <form id="myform">
                                           <fieldset>
                                               ...
                                               <div class="field">
                                                   <input id="subject" type="text" name="phone" placeholder="Phone">
                                               </div>
                                               <div class="field">
                                                   <textarea id="body" rows="5" placeholder="Message"></textarea>
                                               </div>
           ...
           <div class="container">
               <div class="row">
                   ...
                   <div class="col-md-4 col-sm-12">
                       <a href="../index.html"><img class="img-responsive" src="images/logo_footer.png" height="118" width="270" alt="" /></a>
       ...
       <div class="cpy">
           <div class="container">
               <div class="row">
                   <div class="col-md-12">
                       <p><span>All Rights Reserved. Design by<a href="http:\\www.dxateam.c1.biz"> DXATEAM.MAURITIUS</a></span> </br><span>Powered by ACAUST.MAURITIUS</span></p>
                   </div>
               </div>
           </div>
       </div>
